...
const FabricWeaving = ({ isOpen, onClose, assetId }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (priceEth) {
            ...
            try {
                const result = await supplyChain.methods.fabricWeaving(assetId, weiPrice, formState.dyeType, formState.pattern, formState.origin, formState.fabricType).send({ from: accounts[0] });
                console.log(result);
                if (result && assetId) {
                    setSuccessMsg(
                        <span>
                        ...
                        >
                            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-2">
                                    <div className="mb-1">
                                        <label htmlFor="dyeType" className="block text-gray-700 font-medium mb-2">
                                            Dye Type
                                        </label>
                                        <select
                                    ...
                                    <div className="mb-1">
                                        <label htmlFor="pattern" className="block text-gray-700 font-medium mb-2">
                                            Pattern
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="mb-1">
                                        <label htmlFor="fabricType" className="block text-gray-700 font-medium mb-2">
                                            Fabric Type
                                        </label>
                                        <select
                                            className="block w-full border border-gray-400 px-4 py-2 rounded focus:outline-none focus:border-gray-500"
