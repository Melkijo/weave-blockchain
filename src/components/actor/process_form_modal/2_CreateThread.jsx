...
const CreateThread = ({ isOpen, onClose, assetId }) => {
  ...
  const [documentation, setDocumentation] = useState("hallo");
    ...
    if (priceEth && threadType && threadQuality) {
      ...
      try {
        ...
        if (result && assetId) {
          setSuccessMsg(
            <span>
              Asset with <strong>ID {assetId}</strong> succesfully processed at
              price {priceEth}
            </span>
          );
          ...
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
              <form onSubmit={handleSubmit} className="max-w-md mx-auto">
                ...
                <div className="block pl-1 mb-3 text-gray-700 font-small ">
                  ({priceEth} ETH)
                </div>
                <div className="mb-4">
                  <label
