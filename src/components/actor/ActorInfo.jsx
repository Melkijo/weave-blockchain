                        ...
                        >
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div className="mt-2">
                                        <div className="mb-2">
                                            ID :<span className="font-bold"> {actors.id}</span>
                                        </div>
                                        <div className="mb-2">
                                            Name :<span className="font-bold"> {actors.name}</span>
                                        </div>
                                        <div className="mb-2">
                                            Role :<span className="font-bold"> {rolesName[actors.role]}</span></div>
                                        <div className="mb-2">
                                            User Address :<span className="font-bold"> {actors.place}</span>
                                        </div>
                                        <div className="mb-2">
                                            ETH Address :<span className="font-bold"> {actors.address}</span>
